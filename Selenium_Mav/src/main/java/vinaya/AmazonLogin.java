...
public class AmazonLogin {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(2000);
		//Enter mobile number
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("ap_email_login"))).sendKeys("6300724445");
		Thread.sleep(2000);
		//Click continue
		wait.until(ExpectedConditions.elementToBeClickable(By.className("a-button-input"))).click();
		Thread.sleep(2000);
		//Enter password
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("ap_password"))).sendKeys("Amazon@123");
		Thread.sleep(2000);
		//Click on Login
		...
		Thread.sleep(2000);
		//add a product(+)
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//button[@data-testid='add-to-cart-button'])[1]"))).click();
		Thread.sleep(2000);
		//add to cart
